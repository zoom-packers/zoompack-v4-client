...
generate_server_js_tags_file(f'{server_scripts_path}/axes_trims.js', [item_id for item_id in include_item_ids_from_CIA(CIAT_FILE_PATH) if is_axe_by_id(item_id)], 'medievalorigins:axes')