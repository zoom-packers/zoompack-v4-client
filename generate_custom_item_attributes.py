...
new_kjs_config_durability_armor_set("callfromthedepth_", "marblearmor",  get_durability_list_from_helmet(4200), tier=20)
new_kjs_config_durability("callfromthedepth_", "soulmarblehammer", 6100)

new_kjs_config_durability_armor_set("callfromthedepth_", "soularmor",  get_durability_list_from_helmet(4300), tier=20)
new_kjs_config_durability("callfromthedepth_", "dark_abyssscythe", 6300)
