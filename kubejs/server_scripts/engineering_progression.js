...
let lockedBlocksPmmoLevels = {
    ...
    "create:black_postbox":5,
    "create:blue_postbox":5,
    "create:brown_postbox":5,
    "create:cyan_postbox":5,
    "create:gray_postbox":5,
    "create:green_postbox":5,
    "create:light_blue_postbox":5,
    "create:light_gray_postbox":5,
    "create:lime_postbox":5,
    "create:magenta_postbox":5,
    "create:orange_postbox":5,
    "create:pink_postbox":5,
    "create:purple_postbox":5,
    "create:red_postbox":5,
    "create:white_postbox":5,
    "create:yellow_postbox":5,
    "create:black_table_cloth":5,
    "create:blue_table_cloth":5,
    "create:brass_table_cloth":5,
    "create:brown_table_cloth":5,
    "create:cyan_table_cloth":5,
    "create:gray_table_cloth":5,
    "create:green_table_cloth":5,
    "create:light_blue_table_cloth":5,
    "create:light_gray_table_cloth":5,
    "create:lime_table_cloth":5,
    "create:magenta_table_cloth":5,
    "create:orange_table_cloth":5,
    "create:pink_table_cloth":5,
    "create:purple_table_cloth":5,
    "create:red_table_cloth":5,
    "create:white_table_cloth":5,
