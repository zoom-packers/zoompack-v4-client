StartupEvents.registry('item', event => {
    ...
    event.create('tier_5_mana_regen_power_up')
        ...
        .tooltip("§9Apply on armor piece with a template to gain")
        .tooltip('+15.0% Mana Regeneration')
