...
e.create("zoomers_armory:flint_arcane_staff", "staff").displayName("Flint Arcane Staff").maxDamage(100)
e.create("zoomers_armory:flint_woodwind_staff", "staff").displayName("Flint Woodwind Staff").maxDamage(100)
e.create("zoomers_armory:flint_fire_staff", "staff").displayName("Flint Fire Staff").maxDamage(100)
e.create("zoomers_armory:flint_ice_staff", "staff").displayName("Flint Ice Staff").maxDamage(100)
e.create("zoomers_armory:flint_lightning_staff", "staff").displayName("Flint Lightning Staff").maxDamage(100)
e.create("zoomers_armory:flint_nature_staff", "staff").displayName("Flint Nature Staff").maxDamage(100)
e.create("zoomers_armory:flint_holy_staff", "staff").displayName("Flint Holy Staff").maxDamage(100)
e.create("zoomers_armory:flint_blood_staff", "staff").displayName("Flint Blood Staff").maxDamage(100)
e.create("zoomers_armory:flint_evocation_staff", "staff").displayName("Flint Evocation Staff").maxDamage(100)
e.create("zoomers_armory:flint_ender_staff", "staff").displayName("Flint Ender Staff").maxDamage(100)
...
e.create("zoomers_armory:iron_arcane_staff", "staff").displayName("Iron Arcane Staff").maxDamage(250)
e.create("zoomers_armory:iron_woodwind_staff", "staff").displayName("Iron Woodwind Staff").maxDamage(250)
e.create("zoomers_armory:iron_fire_staff", "staff").displayName("Iron Fire Staff").maxDamage(250)
e.create("zoomers_armory:iron_ice_staff", "staff").displayName("Iron Ice Staff").maxDamage(250)
e.create("zoomers_armory:iron_lightning_staff", "staff").displayName("Iron Lightning Staff").maxDamage(250)
e.create("zoomers_armory:iron_nature_staff", "staff").displayName("Iron Nature Staff").maxDamage(250)
e.create("zoomers_armory:iron_holy_staff", "staff").displayName("Iron Holy Staff").maxDamage(250)
e.create("zoomers_armory:iron_blood_staff", "staff").displayName("Iron Blood Staff").maxDamage(250)
e.create("zoomers_armory:iron_evocation_staff", "staff").displayName("Iron Evocation Staff").maxDamage(250)
e.create("zoomers_armory:iron_ender_staff", "staff").displayName("Iron Ender Staff").maxDamage(250)
...
e.create("zoomers_armory:gold_arcane_staff", "staff").displayName("Gold Arcane Staff").maxDamage(50)
e.create("zoomers_armory:gold_woodwind_staff", "staff").displayName("Gold Woodwind Staff").maxDamage(50)
e.create("zoomers_armory:gold_fire_staff", "staff").displayName("Gold Fire Staff").maxDamage(50)
e.create("zoomers_armory:gold_ice_staff", "staff").displayName("Gold Ice Staff").maxDamage(50)
e.create("zoomers_armory:gold_lightning_staff", "staff").displayName("Gold Lightning Staff").maxDamage(50)
e.create("zoomers_armory:gold_nature_staff", "staff").displayName("Gold Nature Staff").maxDamage(50)
e.create("zoomers_armory:gold_holy_staff", "staff").displayName("Gold Holy Staff").maxDamage(50)
e.create("zoomers_armory:gold_blood_staff", "staff").displayName("Gold Blood Staff").maxDamage(50)
e.create("zoomers_armory:gold_evocation_staff", "staff").displayName("Gold Evocation Staff").maxDamage(50)
e.create("zoomers_armory:gold_ender_staff", "staff").displayName("Gold Ender Staff").maxDamage(50)
...
e.create("zoomers_armory:diamond_arcane_staff", "staff").displayName("Diamond Arcane Staff").maxDamage(500)
e.create("zoomers_armory:diamond_woodwind_staff", "staff").displayName("Diamond Woodwind Staff").maxDamage(500)
e.create("zoomers_armory:diamond_fire_staff", "staff").displayName("Diamond Fire Staff").maxDamage(500)
e.create("zoomers_armory:diamond_ice_staff", "staff").displayName("Diamond Ice Staff").maxDamage(500)
e.create("zoomers_armory:diamond_lightning_staff", "staff").displayName("Diamond Lightning Staff").maxDamage(500)
e.create("zoomers_armory:diamond_nature_staff", "staff").displayName("Diamond Nature Staff").maxDamage(500)
e.create("zoomers_armory:diamond_holy_staff", "staff").displayName("Diamond Holy Staff").maxDamage(500)
e.create("zoomers_armory:diamond_blood_staff", "staff").displayName("Diamond Blood Staff").maxDamage(500)
e.create("zoomers_armory:diamond_evocation_staff", "staff").displayName("Diamond Evocation Staff").maxDamage(500)
e.create("zoomers_armory:diamond_ender_staff", "staff").displayName("Diamond Ender Staff").maxDamage(500)
...
e.create("zoomers_armory:neptunium_arcane_staff", "staff").displayName("Neptunium Arcane Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_woodwind_staff", "staff").displayName("Neptunium Woodwind Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_fire_staff", "staff").displayName("Neptunium Fire Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_ice_staff", "staff").displayName("Neptunium Ice Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_lightning_staff", "staff").displayName("Neptunium Lightning Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_nature_staff", "staff").displayName("Neptunium Nature Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_holy_staff", "staff").displayName("Neptunium Holy Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_blood_staff", "staff").displayName("Neptunium Blood Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_evocation_staff", "staff").displayName("Neptunium Evocation Staff").maxDamage(1000)
e.create("zoomers_armory:neptunium_ender_staff", "staff").displayName("Neptunium Ender Staff").maxDamage(1000)
...
e.create("zoomers_armory:pyrope_arcane_staff", "staff").displayName("Pyrope Arcane Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_woodwind_staff", "staff").displayName("Pyrope Woodwind Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_fire_staff", "staff").displayName("Pyrope Fire Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_ice_staff", "staff").displayName("Pyrope Ice Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_lightning_staff", "staff").displayName("Pyrope Lightning Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_nature_staff", "staff").displayName("Pyrope Nature Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_holy_staff", "staff").displayName("Pyrope Holy Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_blood_staff", "staff").displayName("Pyrope Blood Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_evocation_staff", "staff").displayName("Pyrope Evocation Staff").maxDamage(1600)
e.create("zoomers_armory:pyrope_ender_staff", "staff").displayName("Pyrope Ender Staff").maxDamage(1600)
...
e.create("zoomers_armory:aquite_arcane_staff", "staff").displayName("Aquite Arcane Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_woodwind_staff", "staff").displayName("Aquite Woodwind Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_fire_staff", "staff").displayName("Aquite Fire Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_ice_staff", "staff").displayName("Aquite Ice Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_lightning_staff", "staff").displayName("Aquite Lightning Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_nature_staff", "staff").displayName("Aquite Nature Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_holy_staff", "staff").displayName("Aquite Holy Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_blood_staff", "staff").displayName("Aquite Blood Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_evocation_staff", "staff").displayName("Aquite Evocation Staff").maxDamage(1700)
e.create("zoomers_armory:aquite_ender_staff", "staff").displayName("Aquite Ender Staff").maxDamage(1700)
...
e.create("zoomers_armory:diopside_arcane_staff", "staff").displayName("Diopside Arcane Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_woodwind_staff", "staff").displayName("Diopside Woodwind Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_fire_staff", "staff").displayName("Diopside Fire Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_ice_staff", "staff").displayName("Diopside Ice Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_lightning_staff", "staff").displayName("Diopside Lightning Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_nature_staff", "staff").displayName("Diopside Nature Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_holy_staff", "staff").displayName("Diopside Holy Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_blood_staff", "staff").displayName("Diopside Blood Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_evocation_staff", "staff").displayName("Diopside Evocation Staff").maxDamage(1800)
e.create("zoomers_armory:diopside_ender_staff", "staff").displayName("Diopside Ender Staff").maxDamage(1800)
...
e.create("zoomers_armory:charoite_arcane_staff", "staff").displayName("Charoite Arcane Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_woodwind_staff", "staff").displayName("Charoite Woodwind Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_fire_staff", "staff").displayName("Charoite Fire Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_ice_staff", "staff").displayName("Charoite Ice Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_lightning_staff", "staff").displayName("Charoite Lightning Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_nature_staff", "staff").displayName("Charoite Nature Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_holy_staff", "staff").displayName("Charoite Holy Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_blood_staff", "staff").displayName("Charoite Blood Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_evocation_staff", "staff").displayName("Charoite Evocation Staff").maxDamage(1900)
e.create("zoomers_armory:charoite_ender_staff", "staff").displayName("Charoite Ender Staff").maxDamage(1900)
...
e.create("zoomers_armory:horizonite_arcane_staff", "staff").displayName("Horizonite Arcane Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_woodwind_staff", "staff").displayName("Horizonite Woodwind Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_fire_staff", "staff").displayName("Horizonite Fire Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_ice_staff", "staff").displayName("Horizonite Ice Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_lightning_staff", "staff").displayName("Horizonite Lightning Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_nature_staff", "staff").displayName("Horizonite Nature Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_holy_staff", "staff").displayName("Horizonite Holy Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_blood_staff", "staff").displayName("Horizonite Blood Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_evocation_staff", "staff").displayName("Horizonite Evocation Staff").maxDamage(2000)
e.create("zoomers_armory:horizonite_ender_staff", "staff").displayName("Horizonite Ender Staff").maxDamage(2000)
...
e.create("zoomers_armory:zanite_arcane_staff", "staff").displayName("Zanite Arcane Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_woodwind_staff", "staff").displayName("Zanite Woodwind Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_fire_staff", "staff").displayName("Zanite Fire Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_ice_staff", "staff").displayName("Zanite Ice Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_lightning_staff", "staff").displayName("Zanite Lightning Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_nature_staff", "staff").displayName("Zanite Nature Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_holy_staff", "staff").displayName("Zanite Holy Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_blood_staff", "staff").displayName("Zanite Blood Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_evocation_staff", "staff").displayName("Zanite Evocation Staff").maxDamage(2211)
e.create("zoomers_armory:zanite_ender_staff", "staff").displayName("Zanite Ender Staff").maxDamage(2211)
...
e.create("zoomers_armory:enchanted_gravitite_arcane_staff", "staff").displayName("Enchanted Gravitite Arcane Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_woodwind_staff", "staff").displayName("Enchanted Gravitite Woodwind Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_fire_staff", "staff").displayName("Enchanted Gravitite Fire Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_ice_staff", "staff").displayName("Enchanted Gravitite Ice Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_lightning_staff", "staff").displayName("Enchanted Gravitite Lightning Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_nature_staff", "staff").displayName("Enchanted Gravitite Nature Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_holy_staff", "staff").displayName("Enchanted Gravitite Holy Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_blood_staff", "staff").displayName("Enchanted Gravitite Blood Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_evocation_staff", "staff").displayName("Enchanted Gravitite Evocation Staff").maxDamage(2431)
e.create("zoomers_armory:enchanted_gravitite_ender_staff", "staff").displayName("Enchanted Gravitite Ender Staff").maxDamage(2431)
...
e.create("zoomers_armory:cincinnasite_arcane_staff", "staff").displayName("Cincinnasite Arcane Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_woodwind_staff", "staff").displayName("Cincinnasite Woodwind Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_fire_staff", "staff").displayName("Cincinnasite Fire Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_ice_staff", "staff").displayName("Cincinnasite Ice Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_lightning_staff", "staff").displayName("Cincinnasite Lightning Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_nature_staff", "staff").displayName("Cincinnasite Nature Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_holy_staff", "staff").displayName("Cincinnasite Holy Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_blood_staff", "staff").displayName("Cincinnasite Blood Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_evocation_staff", "staff").displayName("Cincinnasite Evocation Staff").maxDamage(2700)
e.create("zoomers_armory:cincinnasite_ender_staff", "staff").displayName("Cincinnasite Ender Staff").maxDamage(2700)
...
e.create("zoomers_armory:cincinnasite_diamond_arcane_staff", "staff").displayName("Cincinnasite Diamond Arcane Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_woodwind_staff", "staff").displayName("Cincinnasite Diamond Woodwind Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_fire_staff", "staff").displayName("Cincinnasite Diamond Fire Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_ice_staff", "staff").displayName("Cincinnasite Diamond Ice Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_lightning_staff", "staff").displayName("Cincinnasite Diamond Lightning Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_nature_staff", "staff").displayName("Cincinnasite Diamond Nature Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_holy_staff", "staff").displayName("Cincinnasite Diamond Holy Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_blood_staff", "staff").displayName("Cincinnasite Diamond Blood Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_evocation_staff", "staff").displayName("Cincinnasite Diamond Evocation Staff").maxDamage(2800)
e.create("zoomers_armory:cincinnasite_diamond_ender_staff", "staff").displayName("Cincinnasite Diamond Ender Staff").maxDamage(2800)
...
e.create("zoomers_armory:nether_ruby_arcane_staff", "staff").displayName("Nether Ruby Arcane Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_woodwind_staff", "staff").displayName("Nether Ruby Woodwind Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_fire_staff", "staff").displayName("Nether Ruby Fire Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_ice_staff", "staff").displayName("Nether Ruby Ice Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_lightning_staff", "staff").displayName("Nether Ruby Lightning Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_nature_staff", "staff").displayName("Nether Ruby Nature Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_holy_staff", "staff").displayName("Nether Ruby Holy Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_blood_staff", "staff").displayName("Nether Ruby Blood Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_evocation_staff", "staff").displayName("Nether Ruby Evocation Staff").maxDamage(2950)
e.create("zoomers_armory:nether_ruby_ender_staff", "staff").displayName("Nether Ruby Ender Staff").maxDamage(2950)
...
e.create("zoomers_armory:flaming_ruby_arcane_staff", "staff").displayName("Flaming Ruby Arcane Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_woodwind_staff", "staff").displayName("Flaming Ruby Woodwind Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_fire_staff", "staff").displayName("Flaming Ruby Fire Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_ice_staff", "staff").displayName("Flaming Ruby Ice Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_lightning_staff", "staff").displayName("Flaming Ruby Lightning Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_nature_staff", "staff").displayName("Flaming Ruby Nature Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_holy_staff", "staff").displayName("Flaming Ruby Holy Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_blood_staff", "staff").displayName("Flaming Ruby Blood Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_evocation_staff", "staff").displayName("Flaming Ruby Evocation Staff").maxDamage(3025)
e.create("zoomers_armory:flaming_ruby_ender_staff", "staff").displayName("Flaming Ruby Ender Staff").maxDamage(3025)
...
e.create("zoomers_armory:netherite_arcane_staff", "staff").displayName("Netherite Arcane Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_woodwind_staff", "staff").displayName("Netherite Woodwind Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_fire_staff", "staff").displayName("Netherite Fire Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_ice_staff", "staff").displayName("Netherite Ice Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_lightning_staff", "staff").displayName("Netherite Lightning Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_nature_staff", "staff").displayName("Netherite Nature Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_holy_staff", "staff").displayName("Netherite Holy Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_blood_staff", "staff").displayName("Netherite Blood Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_evocation_staff", "staff").displayName("Netherite Evocation Staff").maxDamage(3100)
e.create("zoomers_armory:netherite_ender_staff", "staff").displayName("Netherite Ender Staff").maxDamage(3100)
...
e.create("zoomers_armory:cloggrum_arcane_staff", "staff").displayName("Cloggrum Arcane Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_woodwind_staff", "staff").displayName("Cloggrum Woodwind Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_fire_staff", "staff").displayName("Cloggrum Fire Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_ice_staff", "staff").displayName("Cloggrum Ice Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_lightning_staff", "staff").displayName("Cloggrum Lightning Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_nature_staff", "staff").displayName("Cloggrum Nature Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_holy_staff", "staff").displayName("Cloggrum Holy Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_blood_staff", "staff").displayName("Cloggrum Blood Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_evocation_staff", "staff").displayName("Cloggrum Evocation Staff").maxDamage(3300)
e.create("zoomers_armory:cloggrum_ender_staff", "staff").displayName("Cloggrum Ender Staff").maxDamage(3300)
...
e.create("zoomers_armory:froststeel_arcane_staff", "staff").displayName("Froststeel Arcane Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_woodwind_staff", "staff").displayName("Froststeel Woodwind Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_fire_staff", "staff").displayName("Froststeel Fire Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_ice_staff", "staff").displayName("Froststeel Ice Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_lightning_staff", "staff").displayName("Froststeel Lightning Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_nature_staff", "staff").displayName("Froststeel Nature Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_holy_staff", "staff").displayName("Froststeel Holy Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_blood_staff", "staff").displayName("Froststeel Blood Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_evocation_staff", "staff").displayName("Froststeel Evocation Staff").maxDamage(3500)
e.create("zoomers_armory:froststeel_ender_staff", "staff").displayName("Froststeel Ender Staff").maxDamage(3500)
...
e.create("zoomers_armory:utherium_arcane_staff", "staff").displayName("Utherium Arcane Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_woodwind_staff", "staff").displayName("Utherium Woodwind Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_fire_staff", "staff").displayName("Utherium Fire Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_ice_staff", "staff").displayName("Utherium Ice Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_lightning_staff", "staff").displayName("Utherium Lightning Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_nature_staff", "staff").displayName("Utherium Nature Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_holy_staff", "staff").displayName("Utherium Holy Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_blood_staff", "staff").displayName("Utherium Blood Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_evocation_staff", "staff").displayName("Utherium Evocation Staff").maxDamage(3700)
e.create("zoomers_armory:utherium_ender_staff", "staff").displayName("Utherium Ender Staff").maxDamage(3700)
...
e.create("zoomers_armory:forgotten_arcane_staff", "staff").displayName("Forgotten Arcane Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_woodwind_staff", "staff").displayName("Forgotten Woodwind Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_fire_staff", "staff").displayName("Forgotten Fire Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_ice_staff", "staff").displayName("Forgotten Ice Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_lightning_staff", "staff").displayName("Forgotten Lightning Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_nature_staff", "staff").displayName("Forgotten Nature Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_holy_staff", "staff").displayName("Forgotten Holy Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_blood_staff", "staff").displayName("Forgotten Blood Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_evocation_staff", "staff").displayName("Forgotten Evocation Staff").maxDamage(4100)
e.create("zoomers_armory:forgotten_ender_staff", "staff").displayName("Forgotten Ender Staff").maxDamage(4100)
...
e.create("zoomers_armory:jade_arcane_staff", "staff").displayName("Jade Arcane Staff").maxDamage(4000)
e.create("zoomers_armory:jade_woodwind_staff", "staff").displayName("Jade Woodwind Staff").maxDamage(4000)
e.create("zoomers_armory:jade_fire_staff", "staff").displayName("Jade Fire Staff").maxDamage(4000)
e.create("zoomers_armory:jade_ice_staff", "staff").displayName("Jade Ice Staff").maxDamage(4000)
e.create("zoomers_armory:jade_lightning_staff", "staff").displayName("Jade Lightning Staff").maxDamage(4000)
e.create("zoomers_armory:jade_nature_staff", "staff").displayName("Jade Nature Staff").maxDamage(4000)
e.create("zoomers_armory:jade_holy_staff", "staff").displayName("Jade Holy Staff").maxDamage(4000)
e.create("zoomers_armory:jade_blood_staff", "staff").displayName("Jade Blood Staff").maxDamage(4000)
e.create("zoomers_armory:jade_evocation_staff", "staff").displayName("Jade Evocation Staff").maxDamage(4000)
e.create("zoomers_armory:jade_ender_staff", "staff").displayName("Jade Ender Staff").maxDamage(4000)
...
e.create("zoomers_armory:crystalline_arcane_staff", "staff").displayName("Crystalline Arcane Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_woodwind_staff", "staff").displayName("Crystalline Woodwind Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_fire_staff", "staff").displayName("Crystalline Fire Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_ice_staff", "staff").displayName("Crystalline Ice Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_lightning_staff", "staff").displayName("Crystalline Lightning Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_nature_staff", "staff").displayName("Crystalline Nature Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_holy_staff", "staff").displayName("Crystalline Holy Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_blood_staff", "staff").displayName("Crystalline Blood Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_evocation_staff", "staff").displayName("Crystalline Evocation Staff").maxDamage(4600)
e.create("zoomers_armory:crystalline_ender_staff", "staff").displayName("Crystalline Ender Staff").maxDamage(4600)
...
e.create("zoomers_armory:dragon_arcane_staff", "staff").displayName("Dragon Arcane Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_woodwind_staff", "staff").displayName("Dragon Woodwind Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_fire_staff", "staff").displayName("Dragon Fire Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_ice_staff", "staff").displayName("Dragon Ice Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_lightning_staff", "staff").displayName("Dragon Lightning Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_nature_staff", "staff").displayName("Dragon Nature Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_holy_staff", "staff").displayName("Dragon Holy Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_blood_staff", "staff").displayName("Dragon Blood Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_evocation_staff", "staff").displayName("Dragon Evocation Staff").maxDamage(4800)
e.create("zoomers_armory:dragon_ender_staff", "staff").displayName("Dragon Ender Staff").maxDamage(4800)
...
e.create("zoomers_armory:enderite_arcane_staff", "staff").displayName("Enderite Arcane Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_woodwind_staff", "staff").displayName("Enderite Woodwind Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_fire_staff", "staff").displayName("Enderite Fire Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_ice_staff", "staff").displayName("Enderite Ice Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_lightning_staff", "staff").displayName("Enderite Lightning Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_nature_staff", "staff").displayName("Enderite Nature Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_holy_staff", "staff").displayName("Enderite Holy Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_blood_staff", "staff").displayName("Enderite Blood Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_evocation_staff", "staff").displayName("Enderite Evocation Staff").maxDamage(5500)
e.create("zoomers_armory:enderite_ender_staff", "staff").displayName("Enderite Ender Staff").maxDamage(5500)
...
e.create("zoomers_armory:immemorial_arcane_staff", "staff").displayName("Immemorial Arcane Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_woodwind_staff", "staff").displayName("Immemorial Woodwind Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_fire_staff", "staff").displayName("Immemorial Fire Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_ice_staff", "staff").displayName("Immemorial Ice Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_lightning_staff", "staff").displayName("Immemorial Lightning Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_nature_staff", "staff").displayName("Immemorial Nature Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_holy_staff", "staff").displayName("Immemorial Holy Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_blood_staff", "staff").displayName("Immemorial Blood Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_evocation_staff", "staff").displayName("Immemorial Evocation Staff").maxDamage(5700)
e.create("zoomers_armory:immemorial_ender_staff", "staff").displayName("Immemorial Ender Staff").maxDamage(5700)
...
e.create("zoomers_armory:soul_arcane_staff", "staff").displayName("Soul Arcane Staff").maxDamage(6000)
e.create("zoomers_armory:soul_woodwind_staff", "staff").displayName("Soul Woodwind Staff").maxDamage(6000)
e.create("zoomers_armory:soul_fire_staff", "staff").displayName("Soul Fire Staff").maxDamage(6000)
e.create("zoomers_armory:soul_ice_staff", "staff").displayName("Soul Ice Staff").maxDamage(6000)
e.create("zoomers_armory:soul_lightning_staff", "staff").displayName("Soul Lightning Staff").maxDamage(6000)
e.create("zoomers_armory:soul_nature_staff", "staff").displayName("Soul Nature Staff").maxDamage(6000)
e.create("zoomers_armory:soul_holy_staff", "staff").displayName("Soul Holy Staff").maxDamage(6000)
e.create("zoomers_armory:soul_blood_staff", "staff").displayName("Soul Blood Staff").maxDamage(6000)
e.create("zoomers_armory:soul_evocation_staff", "staff").displayName("Soul Evocation Staff").maxDamage(6000)
e.create("zoomers_armory:soul_ender_staff", "staff").displayName("Soul Ender Staff").maxDamage(6000)
...
e.create("zoomers_armory:fixed_bone_arcane_staff", "staff").displayName("Fixed Bone Arcane Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_woodwind_staff", "staff").displayName("Fixed Bone Woodwind Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_fire_staff", "staff").displayName("Fixed Bone Fire Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_ice_staff", "staff").displayName("Fixed Bone Ice Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_lightning_staff", "staff").displayName("Fixed Bone Lightning Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_nature_staff", "staff").displayName("Fixed Bone Nature Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_holy_staff", "staff").displayName("Fixed Bone Holy Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_blood_staff", "staff").displayName("Fixed Bone Blood Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_evocation_staff", "staff").displayName("Fixed Bone Evocation Staff").maxDamage(6100)
e.create("zoomers_armory:fixed_bone_ender_staff", "staff").displayName("Fixed Bone Ender Staff").maxDamage(6100)
...
e.create("zoomers_armory:fusion_arcane_staff", "staff").displayName("Fusion Arcane Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_woodwind_staff", "staff").displayName("Fusion Woodwind Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_fire_staff", "staff").displayName("Fusion Fire Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_ice_staff", "staff").displayName("Fusion Ice Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_lightning_staff", "staff").displayName("Fusion Lightning Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_nature_staff", "staff").displayName("Fusion Nature Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_holy_staff", "staff").displayName("Fusion Holy Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_blood_staff", "staff").displayName("Fusion Blood Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_evocation_staff", "staff").displayName("Fusion Evocation Staff").maxDamage(6250)
e.create("zoomers_armory:fusion_ender_staff", "staff").displayName("Fusion Ender Staff").maxDamage(6250)
...
e.create("zoomers_armory:aberythe_arcane_staff", "staff").displayName("Aberythe Arcane Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_woodwind_staff", "staff").displayName("Aberythe Woodwind Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_fire_staff", "staff").displayName("Aberythe Fire Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_ice_staff", "staff").displayName("Aberythe Ice Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_lightning_staff", "staff").displayName("Aberythe Lightning Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_nature_staff", "staff").displayName("Aberythe Nature Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_holy_staff", "staff").displayName("Aberythe Holy Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_blood_staff", "staff").displayName("Aberythe Blood Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_evocation_staff", "staff").displayName("Aberythe Evocation Staff").maxDamage(6500)
e.create("zoomers_armory:aberythe_ender_staff", "staff").displayName("Aberythe Ender Staff").maxDamage(6500)
...
e.create("zoomers_armory:ignisithe_arcane_staff", "staff").displayName("Ignisithe Arcane Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_woodwind_staff", "staff").displayName("Ignisithe Woodwind Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_fire_staff", "staff").displayName("Ignisithe Fire Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_ice_staff", "staff").displayName("Ignisithe Ice Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_lightning_staff", "staff").displayName("Ignisithe Lightning Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_nature_staff", "staff").displayName("Ignisithe Nature Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_holy_staff", "staff").displayName("Ignisithe Holy Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_blood_staff", "staff").displayName("Ignisithe Blood Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_evocation_staff", "staff").displayName("Ignisithe Evocation Staff").maxDamage(6750)
e.create("zoomers_armory:ignisithe_ender_staff", "staff").displayName("Ignisithe Ender Staff").maxDamage(6750)
...
e.create("zoomers_armory:knight_arcane_staff", "staff").displayName("Knight Arcane Staff").maxDamage(6875)
e.create("zoomers_armory:knight_woodwind_staff", "staff").displayName("Knight Woodwind Staff").maxDamage(6875)
e.create("zoomers_armory:knight_fire_staff", "staff").displayName("Knight Fire Staff").maxDamage(6875)
e.create("zoomers_armory:knight_ice_staff", "staff").displayName("Knight Ice Staff").maxDamage(6875)
e.create("zoomers_armory:knight_lightning_staff", "staff").displayName("Knight Lightning Staff").maxDamage(6875)
e.create("zoomers_armory:knight_nature_staff", "staff").displayName("Knight Nature Staff").maxDamage(6875)
e.create("zoomers_armory:knight_holy_staff", "staff").displayName("Knight Holy Staff").maxDamage(6875)
e.create("zoomers_armory:knight_blood_staff", "staff").displayName("Knight Blood Staff").maxDamage(6875)
e.create("zoomers_armory:knight_evocation_staff", "staff").displayName("Knight Evocation Staff").maxDamage(6875)
e.create("zoomers_armory:knight_ender_staff", "staff").displayName("Knight Ender Staff").maxDamage(6875)
...
e.create("zoomers_armory:glacerythe_arcane_staff", "staff").displayName("Glacerythe Arcane Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_woodwind_staff", "staff").displayName("Glacerythe Woodwind Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_fire_staff", "staff").displayName("Glacerythe Fire Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_ice_staff", "staff").displayName("Glacerythe Ice Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_lightning_staff", "staff").displayName("Glacerythe Lightning Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_nature_staff", "staff").displayName("Glacerythe Nature Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_holy_staff", "staff").displayName("Glacerythe Holy Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_blood_staff", "staff").displayName("Glacerythe Blood Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_evocation_staff", "staff").displayName("Glacerythe Evocation Staff").maxDamage(7000)
e.create("zoomers_armory:glacerythe_ender_staff", "staff").displayName("Glacerythe Ender Staff").maxDamage(7000)
...
e.create("zoomers_armory:garnite_arcane_staff", "staff").displayName("Garnite Arcane Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_woodwind_staff", "staff").displayName("Garnite Woodwind Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_fire_staff", "staff").displayName("Garnite Fire Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_ice_staff", "staff").displayName("Garnite Ice Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_lightning_staff", "staff").displayName("Garnite Lightning Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_nature_staff", "staff").displayName("Garnite Nature Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_holy_staff", "staff").displayName("Garnite Holy Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_blood_staff", "staff").displayName("Garnite Blood Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_evocation_staff", "staff").displayName("Garnite Evocation Staff").maxDamage(7250)
e.create("zoomers_armory:garnite_ender_staff", "staff").displayName("Garnite Ender Staff").maxDamage(7250)
...
e.create("zoomers_armory:phantom_arcane_staff", "staff").displayName("Phantom Arcane Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_woodwind_staff", "staff").displayName("Phantom Woodwind Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_fire_staff", "staff").displayName("Phantom Fire Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_ice_staff", "staff").displayName("Phantom Ice Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_lightning_staff", "staff").displayName("Phantom Lightning Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_nature_staff", "staff").displayName("Phantom Nature Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_holy_staff", "staff").displayName("Phantom Holy Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_blood_staff", "staff").displayName("Phantom Blood Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_evocation_staff", "staff").displayName("Phantom Evocation Staff").maxDamage(7500)
e.create("zoomers_armory:phantom_ender_staff", "staff").displayName("Phantom Ender Staff").maxDamage(7500)
...
e.create("zoomers_armory:unorithe_arcane_staff", "staff").displayName("Unorithe Arcane Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_woodwind_staff", "staff").displayName("Unorithe Woodwind Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_fire_staff", "staff").displayName("Unorithe Fire Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_ice_staff", "staff").displayName("Unorithe Ice Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_lightning_staff", "staff").displayName("Unorithe Lightning Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_nature_staff", "staff").displayName("Unorithe Nature Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_holy_staff", "staff").displayName("Unorithe Holy Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_blood_staff", "staff").displayName("Unorithe Blood Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_evocation_staff", "staff").displayName("Unorithe Evocation Staff").maxDamage(7750)
e.create("zoomers_armory:unorithe_ender_staff", "staff").displayName("Unorithe Ender Staff").maxDamage(7750)
...
e.create("zoomers_armory:incorythe_arcane_staff", "staff").displayName("Incorythe Arcane Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_woodwind_staff", "staff").displayName("Incorythe Woodwind Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_fire_staff", "staff").displayName("Incorythe Fire Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_ice_staff", "staff").displayName("Incorythe Ice Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_lightning_staff", "staff").displayName("Incorythe Lightning Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_nature_staff", "staff").displayName("Incorythe Nature Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_holy_staff", "staff").displayName("Incorythe Holy Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_blood_staff", "staff").displayName("Incorythe Blood Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_evocation_staff", "staff").displayName("Incorythe Evocation Staff").maxDamage(8000)
e.create("zoomers_armory:incorythe_ender_staff", "staff").displayName("Incorythe Ender Staff").maxDamage(8000)
