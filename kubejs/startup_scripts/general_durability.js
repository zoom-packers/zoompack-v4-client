...
ItemEvents.modification((event) => {
    ...
    event.modify("theabyss:aberythe_axe", item => {
        item.maxDamage = 6250;
    });
    event.modify("theabyss:aberythe_pickaxe", item => {
        item.maxDamage = 6250;
    });
    event.modify("theabyss:aberythe_shovel", item => {
        item.maxDamage = 6250;
    });
    event.modify("theabyss:aberythe_hoe", item => {
        item.maxDamage = 6250;
    });
    ...
    event.modify("theabyss:bone_axe", item => {
        item.maxDamage = 6500;
    });
    event.modify("theabyss:bone_pickaxe", item => {
        item.maxDamage = 6500;
    });
    event.modify("theabyss:bone_shovel", item => {
        item.maxDamage = 6500;
    });
    ...
    event.modify("theabyss:bricked_knight_sword", item => {
        item.maxDamage = 6750;
    });
