...
declare const sdrp: {
     ...
     * @at *client*
    */
dimension_change(handler: (event: Internal.SDRPKubeJSIntegration$ClientDimensionChangeEvent) => void):void,
};
...
registry(type: "armoryjs:material", handler: (event: Registry.Material) => void):void,
...
registry(type: "doggytalents:accessories", handler: (event: Registry.Accessories) => void):void,
registry(type: "doggytalents:accessory_type", handler: (event: Registry.AccessoryType) => void):void,
registry(type: "doggytalents:dog_variant", handler: (event: Registry.DogVariant) => void):void,
registry(type: "doggytalents:talents", handler: (event: Registry.Talents) => void):void,
...
registry(type: "minecolonies:fields", handler: (event: Registry.Fields) => void):void,
