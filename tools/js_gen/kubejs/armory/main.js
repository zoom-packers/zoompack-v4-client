...
const materials = [
    {item: item_minecraft.i_flint, type: "crafting", name: "flint", base_damage: 4, durability: 100, armor: 0.5, pmmoLevel: 3, materialColor: "#232323"},
    {item: item_minecraft.i_iron_ingot, type: "crafting", "name": "iron", base_damage: 7, durability: 250, armor: 1, pmmoLevel: 9, materialColor: "#C0C0C0"},
    {item: item_minecraft.i_gold_ingot, type: "crafting", name: "gold", base_damage: 6, durability: 50, armor: 1.5, pmmoLevel: 12, materialColor: "#FFD700"},
    {item: item_minecraft.i_diamond, type: "crafting", name: "diamond", base_damage: 8, durability: 500, armor: 2, pmmoLevel: 18, materialColor: "#00FFFF"},
    {item: item_aquaculture.i_neptunium_ingot, type: "crafting", name: "neptunium", base_damage: 8.5, durability: 1000, armor: 2, pmmoLevel: 19, materialColor: "#2cb28e", skip: ["bow"]},

    // Blue skies
    {item: item_blue_skies.i_pyrope_gem, type: "crafting", name: "pyrope", base_damage: 8, durability: 1600, armor: 2.5, pmmoLevel: 21, materialColor: "#e61542"},
    {item: item_blue_skies.i_aquite, type: "crafting", name: "aquite", base_damage: 8.5, durability: 1700, armor: 2.75, pmmoLevel: 23, materialColor: "#5aeaea"},
    {item: item_blue_skies.i_diopside_gem, type: "crafting", name: "diopside", base_damage: 8.7, durability: 1800, armor: 3, pmmoLevel: 25, materialColor: "#35bf35"},
    {item: item_blue_skies.i_charoite, type: "crafting", name: "charoite", base_damage: 9, durability: 1900, armor: 3.5, pmmoLevel: 29, materialColor: "#bf35af"},
    {item: item_blue_skies.i_horizonite_ingot, type: "crafting", name: "horizonite", base_damage: 10.5, durability: 2000, armor: 4.5, pmmoLevel: 32, materialColor: "#FFA500"},
    
    // Aether
    {item: item_aether.i_zanite_gemstone, type: "crafting", name: "zanite", base_damage: 11, durability: 2211, armor: 5, pmmoLevel: 35, materialColor: "#75108a"},
    {item: item_aether.i_enchanted_gravitite, type: "crafting", name: "enchanted_gravitite", base_damage: 12, durability: 2431, armor: 6, pmmoLevel: 39, materialColor: "#8a1053"},
    
    // Nether
    {item: item_betternether.i_cincinnasite_ingot, type: "crafting", name: "cincinnasite", base_damage: 17, durability: 2700, armor: 11, pmmoLevel: 52, materialColor: "#c28721"},
    {item: item_minecraft.i_diamond, type: "smithing", name: "cincinnasite_diamond", smithing: item_betternether.i_cincinnasite_diamond_upgrade_smithing_template, "base": "cincinnasite", base_damage: 18, durability: 2800, armor: 12, pmmoLevel: 54, materialColor: "#764e1e"},
    {item: item_betternether.i_nether_ruby, type: "crafting", name: "nether_ruby", base_damage: 21, durability: 2950, armor: 15, pmmoLevel: 56, materialColor: "#FF0000"},
    {item: item_minecraft.i_sculk_catalyst, type: "smithing", name: "flaming_ruby", smithing: item_betternether.i_flaming_ruby_upgrade_smithing_template, "base": "nether_ruby", base_damage: 25, durability: 3025, armor: 19, pmmoLevel: 57, materialColor: "#e50e6a"},
    {item: item_minecraft.i_netherite_ingot, type: "smithing", name: "netherite", smithing: item_minecraft.i_netherite_upgrade_smithing_template, base: "diamond", base_damage: 31, durability: 3100, armor: 15, pmmoLevel: 58, materialColor: "#282224"},
    
    // Undergarden
    {item: item_undergarden.i_cloggrum_ingot, type: "crafting", name: "cloggrum", base_damage: 61, durability: 3300, armor: 55, pmmoLevel: 61, materialColor: "#b1a17b"},
    {item: item_undergarden.i_froststeel_ingot, type: "crafting", name: "froststeel", base_damage: 71, durability: 3500, armor: 65, pmmoLevel: 63, materialColor: "#3786aa"},
    {item: item_undergarden.i_utherium_crystal, type: "crafting", name: "utherium", base_damage: 81, durability: 3700, armor: 75, pmmoLevel: 65, materialColor: "#831414"},
    {item: item_undergarden.i_forgotten_ingot, type: "smithing", name: "forgotten", smithing: item_undergarden.i_forgotten_upgrade_smithing_template, "base": "utherium", base_damage: 91, durability: 4100, armor: 85, pmmoLevel: 67, materialColor: "#29ae63"},
    {item: item_call_of_yucutan.i_jade, type: "crafting", name: "jade", base_damage: 86, durability: 4000, armor: 80, pmmoLevel: 69, materialColor: "#2f7d5c"},
    ...
    // Call from the depth
    {item: item_callfromthedepth_.i_immemorialingot, type: "crafting", name: "immemorial", base_damage: 206, durability: 5700, armor: 200, pmmoLevel: 84, materialColor: "#629592"},
    {item: item_callfromthedepth_.i_soulingot, type: "smithing", name: "soul", smithing: item_callfromthedepth_.i_immemorialupgradesmithingtemplate, "base": "depth", base_damage: 226, durability: 6000, armor: 220, pmmoLevel: 88, materialColor: "#5474b4", skip:["bow"]},
    
    // Abyss
    {item: item_theabyss.i_fixed_bone, type: "crafting", name: "fixed_bone", base_damage: 245, durability: 6100, armor: 239, pmmoLevel: 90, materialColor: "#c6c6c6"},
    {item: item_theabyss.i_fusion_ingot, type: "crafting", name: "fusion", base_damage: 229, durability: 6250, armor: 223, pmmoLevel: 91, materialColor: "#39ebc7"},
    {item: item_theabyss.i_aberythe_gem, type: "crafting", name: "aberythe", base_damage: 238, durability: 6500, armor: 232, pmmoLevel: 92, materialColor: "#451e63"},
    {item: item_theabyss.i_ignisithe_gem, type: "crafting", name: "ignisithe", base_damage: 268, durability: 6750, armor: 262, pmmoLevel: 93, materialColor: "#33c0a4"},
    {item: item_theabyss.i_fixed_bone, type: "crafting", name: "knight", base_damage: 278, durability: 6875, armor: 272, pmmoLevel: 94, materialColor: "#969190"},
    {item: item_theabyss.i_glacerythe_gem, type: "crafting", name: "glacerythe", base_damage: 291, durability: 7000, armor: 285, pmmoLevel: 94, materialColor: "#2b9d86"},
    {item: item_theabyss.i_garnite_ingot, type: "crafting", name: "garnite", base_damage: 308, durability: 7250, armor: 302, pmmoLevel: 95, materialColor: "#268251"},
    {item: item_theabyss.i_phantom_ingot, type: "crafting", name: "phantom", base_damage: 330, durability: 7500, armor: 324, pmmoLevel: 96, materialColor: "#0f5226"},
    {item: item_theabyss.i_unorithe_ingot, type: "crafting", name: "unorithe", base_damage: 361, durability: 7750, armor: 355, pmmoLevel: 97, materialColor: "#092a23"},
    {item: item_theabyss.i_incorythe_gem, type: "crafting", name: "incorythe", base_damage: 406, durability: 8000, armor: 400, pmmoLevel: 98, materialColor: "#72d5ca"},
...
const weaponTypes = [
    {name: "claws", recipe: ["","","","","material","material","","",""], durabilityMultiplier: 0.8, damageMultiplier: 0.7, speedMultiplier: 0.5, textureGenType: "claws"},
    ...
    {name: "scythe", recipe: ["material","material","","#forge:rods/wooden","material","","#forge:rods/wooden","",""], durabilityMultiplier: 1.5, damageMultiplier: 1.25, speedMultiplier: -0.4, textureGenType: "long"},
]
...
for (const material of materials) {
    for (const weaponType of weaponTypes) {
        ...
        const id = `${modId}:${materialIdPart}_${weaponType.name}`;
        let entry;
        if (weaponType.name === "claws") {
            entry = createCiaUnarmedWeapon(id, material, weaponType);
        } else {
            entry = createCiaWeapon(id, material, weaponType);
        }
...
function createCiaUnarmedWeapon(itemId, material, weaponType) {
    return createCiaMainHand(itemId, [
        {
