...
const materials = [
    {item: item_minecraft.i_flint, type: "crafting", name: "flint", base_damage: -2, durability: 100, armor: 0.5},
    {item: item_minecraft.i_iron_ingot, type: "crafting", "name": "iron", base_damage: 1, durability: 250, armor: 1},
    {item: item_minecraft.i_gold_ingot, type: "crafting", name: "gold", base_damage: 1.5, durability: 50, armor: 1.5},
    {item: item_minecraft.i_diamond, type: "crafting", name: "diamond", base_damage: 2, durability: 500, armor: 2},
    {item: item_minecraft.i_netherite_ingot, type: "smithing", name: "netherite", smithing: item_minecraft.i_netherite_upgrade_smithing_template, base: "diamond", base_damage: 25, durability: 1650, armor: 15},
    {item: item_blue_skies.i_pyrope_gem, type: "crafting", name: "pyrope", base_damage: 2, durability: 800, armor: 2.5},
    {item: item_blue_skies.i_aquite, type: "crafting", name: "aquite", base_damage: 2.5, durability: 850, armor: 2.7},
    {item: item_blue_skies.i_diopside_gem, type: "crafting", name: "diopside", base_damage: 2.7, durability: 900, armor: 3},
    {item: item_blue_skies.i_charoite, type: "crafting", name: "charoite", base_damage: 3, durability: 950, armor: 3.5},
    {item: item_blue_skies.i_horizonite_ingot, type: "crafting", name: "horizonite", base_damage: 4.5, durability: 1000, armor: 4},
    {item: item_aether.i_zanite_gemstone, type: "crafting", name: "zanite", base_damage: 5, durability: 1100, armor: 5},
    {item: item_aether.i_enchanted_gravitite, type: "crafting", name: "enchanted_gravitite", base_damage: 6, durability: 1200, armor: 6},
    {item: item_betternether.i_cincinnasite_ingot, type: "crafting", name: "cincinnasite", base_damage: 11, durability: 1300, armor: 11},
    {item: item_minecraft.i_diamond, type: "smithing", name: "cincinnasite_diamond", smithing: item_betternether.i_cincinnasite_diamond_upgrade_smithing_template, "base": "cincinnasite", base_damage: 12, durability: 1400, armor: 12},
    {item: item_betternether.i_nether_ruby, type: "crafting", name: "nether_ruby", base_damage: 15, durability: 1500, armor: 15},
    {item: item_minecraft.i_sculk_catalyst, type: "smithing", name: "flaming_ruby", smithing: item_betternether.i_flaming_ruby_upgrade_smithing_template, "base": "nether_ruby", base_damage: 19, durability: 1600, armor: 19},
    {item: item_undergarden.i_cloggrum_ingot, type: "crafting", name: "cloggrum", base_damage: 55, durability: 1700, armor: 55},
    {item: item_undergarden.i_froststeel_ingot, type: "crafting", name: "froststeel", base_damage: 65, durability: 1800, armor: 65},
    {item: item_undergarden.i_utherium_crystal, type: "crafting", name: "utherium", base_damage: 75, durability: 1900, armor: 75},
    {item: item_undergarden.i_forgotten_ingot, type: "smithing", name: "forgotten", smithing: item_undergarden.i_forgotten_upgrade_smithing_template, "base": "utherium", base_damage: 85, durability: 2000, armor: 85},
    {item: item_betterend.i_thallasium_forged_plate, type: "crafting", name: "thallasium", base_damage: 100, durability: 2200, armor: 100},
    {item: item_betterend.i_terminite_ingot, type: "crafting", name: "terminite", base_damage: 127, durability: 2400, armor: 127},
    {item: item_betterend.i_aeternium_forged_plate, type: "crafting", name: "aeternium", base_damage: 157, durability: 2600, armor: 157},
    {item: item_betterend.i_aurora_crystal, type: "crafting", name: "aurora", base_damage: 186, durability: 2800, armor: 186},
    {item: "callfromthedepth_:immemorialingot", type: "crafting", name: "immemorial", base_damage: 200, durability: 2800, armor: 200},
    {item: item_theabyss.i_fixed_bone, type: "crafting", name: "fixed_bone", base_damage: 239, durability: 3200, armor: 239},
    {item: item_theabyss.i_fusion_ingot, type: "crafting", name: "fusion", base_damage: 223, durability: 3400, armor: 223},
    {item: item_theabyss.i_aberythe_gem, type: "crafting", name: "aberythe", base_damage: 232, durability: 3600, armor: 232},
    {item: item_theabyss.i_ignisithe_gem, type: "crafting", name: "ignisithe", base_damage: 262, durability: 3800, armor: 262},
    {item: item_theabyss.i_glacerythe_gem, type: "crafting", name: "glacerythe", base_damage: 285, durability: 4000, armor: 285},
    {item: item_theabyss.i_garnite_ingot, type: "crafting", name: "garnite", base_damage: 302, durability: 4200, armor: 302},
    {item: item_theabyss.i_phantom_ingot, type: "crafting", name: "phantom", base_damage: 324, durability: 4400, armor: 324},
    {item: item_theabyss.i_unorithe_ingot, type: "crafting", name: "unorithe", base_damage: 355, durability: 4600, armor: 355},
]
