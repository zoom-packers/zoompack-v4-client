...
const materials = [
    ...
    {item: item_minecraft.i_netherite_ingot, type: "smithing", name: "netherite", smithing: item_minecraft.i_netherite_upgrade_smithing_template, base: "diamond", base_damage: 25, durability: 1650, armor: 15, pmmoLevel: 58, materialColor: "#282224"},
    {item: item_blue_skies.i_pyrope_gem, type: "crafting", name: "pyrope", base_damage: 2, durability: 800, armor: 2.5, pmmoLevel: 21, materialColor: "#e61542"},
    {item: item_blue_skies.i_aquite, type: "crafting", name: "aquite", base_damage: 2.5, durability: 850, armor: 2.75, pmmoLevel: 23, materialColor: "#5aeaea"},
    {item: item_blue_skies.i_diopside_gem, type: "crafting", name: "diopside", base_damage: 2.7, durability: 900, armor: 3, pmmoLevel: 25, materialColor: "#35bf35"},
    {item: item_blue_skies.i_charoite, type: "crafting", name: "charoite", base_damage: 3, durability: 950, armor: 3.5, pmmoLevel: 29, materialColor: "#bf35af"},
    {item: item_blue_skies.i_horizonite_ingot, type: "crafting", name: "horizonite", base_damage: 4.5, durability: 1000, armor: 4.5, pmmoLevel: 32, materialColor: "#FFA500"},
    {item: item_aether.i_zanite_gemstone, type: "crafting", name: "zanite", base_damage: 5, durability: 1100, armor: 5, pmmoLevel: 35, materialColor: "#75108a"},
    {item: item_aether.i_enchanted_gravitite, type: "crafting", name: "enchanted_gravitite", base_damage: 6, durability: 1200, armor: 6, pmmoLevel: 39, materialColor: "#8a1053"},
    {item: item_betternether.i_cincinnasite_ingot, type: "crafting", name: "cincinnasite", base_damage: 11, durability: 1300, armor: 11, pmmoLevel: 52, materialColor: "#c28721"},
    ...
    {item: item_theabyss.i_ignisithe_gem, type: "crafting", name: "ignisithe", base_damage: 262, durability: 3800, armor: 262, pmmoLevel: 93, materialColor: "#33c0a4"},
    {item: item_theabyss.i_glacerythe_gem, type: "crafting", name: "glacerythe", base_damage: 285, durability: 4000, armor: 285, pmmoLevel: 94, materialColor: "#2b9d86"},
    {item: item_theabyss.i_garnite_ingot, type: "crafting", name: "garnite", base_damage: 302, durability: 4200, armor: 302, pmmoLevel: 95, materialColor: "#268251"},
    {item: item_theabyss.i_phantom_ingot, type: "crafting", name: "phantom", base_damage: 324, durability: 4400, armor: 324, pmmoLevel: 96, materialColor: "#0f5226"},
    {item: item_theabyss.i_unorithe_ingot, type: "crafting", name: "unorithe", base_damage: 355, durability: 4600, armor: 355, pmmoLevel: 97, materialColor: "#092a23"},
]
