...
function modifyCreate() {
    ...
    processor.modifyPlaceBlockRequirements("create", "item_hatch", "engineering", 5);       //create 6
    ...
    processor.modifyPlaceBlockRequirements("create", "black_table_cloth", "engineering", 5);        //create 6       
    processor.modifyPlaceBlockRequirements("create", "blue_table_cloth", "engineering", 5);         //create 6
    processor.modifyPlaceBlockRequirements("create", "brass_table_cloth", "engineering", 5);        //create 6
    processor.modifyPlaceBlockRequirements("create", "brown_table_cloth", "engineering", 5);        //create 6
    processor.modifyPlaceBlockRequirements("create", "cyan_table_cloth", "engineering", 5);         //create 6
    processor.modifyPlaceBlockRequirements("create", "gray_table_cloth", "engineering", 5);         //create 6
    processor.modifyPlaceBlockRequirements("create", "green_table_cloth", "engineering", 5);        //create 6
    processor.modifyPlaceBlockRequirements("create", "light_blue_table_cloth", "engineering", 5);   //create 6
    processor.modifyPlaceBlockRequirements("create", "light_gray_table_cloth", "engineering", 5);   //create 6
    processor.modifyPlaceBlockRequirements("create", "lime_table_cloth", "engineering", 5);         //create 6
    processor.modifyPlaceBlockRequirements("create", "magenta_table_cloth", "engineering", 5);      //create 6
    processor.modifyPlaceBlockRequirements("create", "orange_table_cloth", "engineering", 5);       //create 6
    processor.modifyPlaceBlockRequirements("create", "pink_table_cloth", "engineering", 5);         //create 6
    processor.modifyPlaceBlockRequirements("create", "purple_table_cloth", "engineering", 5);       //create 6
    processor.modifyPlaceBlockRequirements("create", "red_table_cloth", "engineering", 5);          //create 6
    processor.modifyPlaceBlockRequirements("create", "white_table_cloth", "engineering", 5);        //create 6
    processor.modifyPlaceBlockRequirements("create", "yellow_table_cloth", "engineering", 5);       //create 6
    processor.modifyPlaceBlockRequirements("create", "andesite_table_cloth", "engineering", 5);     //create 6
    ...
    processor.modifyPlaceBlockRequirements("create", "chain_conveyor", "engineering", 7);           //create 6
    ...
    processor.modifyPlaceBlockRequirements("create", "desk_bell", "engineering", 10);               //create 6
    processor.modifyPlaceBlockRequirements("create", "copper_table_cloth", "engineering", 10);      //create 6
    
    
    processor.modifyPlaceBlockRequirements("create", "pulse_timer", "engineering", 10);             //create 6
    ...
    processor.modifyPlaceBlockRequirements("create", "package_frogport", "engineering", 12);        //create 6
    processor.modifyPlaceBlockRequirements("create", "redstone_requester", "engineering", 12);      //create 6
    processor.modifyPlaceBlockRequirements("create", "stock_link", "engineering", 12);              //create 6
    processor.modifyPlaceBlockRequirements("create", "stock_ticker", "engineering", 12);            //create 6
    processor.modifyPlaceBlockRequirements("create", "item_vault", "engineering", 12);

    processor.modifyPlaceBlockRequirements("create", "brass_table_cloth", "engineering", 15);       //create 6
    processor.modifyPlaceBlockRequirements("create", "cardboard_block", "engineering", 15);         //create 6
    processor.modifyPlaceBlockRequirements("create", "bound_cardboard_block", "engineering", 15);   //create 6
    processor.modifyPlaceBlockRequirements("create", "packager", "engineering", 15);                //create 6
    processor.modifyPlaceBlockRequirements("create", "repackager", "engineering", 15);              //create 6
    ...
    processor.modifyPlaceBlockRequirements("create", "factory_gauge", "engineering", 16);           //create 6
